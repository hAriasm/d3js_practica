...
\title{Análisis de las Epidemias y la Movilidad Humana: Una Revisión Sistemática}
...
\begin{abstract}
La propagación de enfermedades infecciosas como el COVID-19 está intrínsecamente vinculada a los patrones de movilidad humana. Existen estudios recientes que proponen modelos para el análisis de esta relación. En este trabajo se realizará una revisión sistemática para evaluar el estado actual de la investigación sobre el uso de los datos de movilidad humana en el análisis visual y modelado de la propagación de epidemias, y así determinar cómo estos enfoques mejoran la comprensión y gestión de las dinámicas espacio-temporales de enfermedades infecciosas. Se estudiaron 13 artículos publicados entre el 2019 y 2024, los cuales realizan una análisis sobre datos de movilidad humana para modelar la propagación de epidemias y aplican herramientas de visualización espacio-temporal. Los resultados demuestran que la integración de datos espacio temporales de movilidad mejora la precisión en la identificación de patrones de propagación y permite evaluar de manera más efectiva la eficacia de medidas de mitigación como cuarentenas y distanciamiento social.

\end{abstract}

\keywords{Movilidad humana, epidemias, visualización espacio-temporal, COVID-19}
...
\textbf{Inclusión}: Estudios que utilizan datos de movilidad humana para modelar la propagación de enfermedades infecciosas.
...
\textbf{Exclusión}: Estudios que no proporcionan datos empíricos.
...
\subsection{Extraccíón de Datos y Síntesis}
...
\begin{minipage}[t]{11cm}
  \begin{itemize}
    ...
    \item Propuestas de análisis visual:  gráficos para visualizar.
  \end{itemize}
\end{minipage} \\ \hline
...
\begin{table*}[h]
\centering
\caption{Técnicas Informáticas y Algoritmos Utilizados en los Estudios Revisados}
\resizebox{\textwidth}{!}{

\begin{tabular}{|p{4cm}|p{12cm}|}
\hline
        \textbf{Referencia} & \textbf{Técnicas y Algoritmos Utilizados} \\
        \hline
        \cite{li2021odt} & Motores de consulta escalables para manejar grandes cantidades de información de manera eficiente, procesamiento distribuido de grandes volúmenes de datos para garantizar la escalabilidad y la resiliencia, optimización de consultas para mejorar el rendimiento mediante el uso de índices y técnicas de particionamiento, técnicas de extracción de datos de movilidad. \\
        \hline
        \cite{yanez2021pandemcap} & Modelos epidémicos, analítica visual para soporte a decisiones. \\
        \hline
        \cite{li2024vivian} & Modelo SEIR, simulación de trayectorias de contacto. \\
        \hline
        \cite{luo2016geo} & Modelos epidémicos basados en agentes, matriz reorganizable para análisis visual. \\
        \hline
        \cite{du2021dynamics} & Modelos con efectos de cuarentena y movilidad intra e interregional. \\
        \hline
        \cite{pappalardo2023dataset} & Análisis de registros de datos extendidos (XDR) para evaluar movilidad. \\
        \hline
        \cite{wei2020spread} & Modelo basado en red urbana para simular propagación interurbana. \\
        \hline
        \cite{zhang2019visual} & Integración de datos urbanos y médicos, análisis visual de la dinámica de salud urbana. \\
        \hline
        \cite{yang2022epimob} & Simulación interactiva de restricciones de movilidad. \\
        \hline
        \cite{zhang2023data} & Modelos impulsados por datos de movilidad espaciotemporal. \\
        \hline
        \cite{kim2024scoping} & Mapas coropléticos, gráficos de línea, técnicas de interpolación. \\
        \hline
        \cite{wu2024patterns} & Técnica de flujo potencial, EPViz para análisis visual. \\
        \hline
        \cite{afzal2011visual} & Simulación basada en parámetros epidemiológicos, árboles de decisión. \\
        \hline
\end{tabular}}
    \label{tab:techniques_algorithms}
\end{table*}
